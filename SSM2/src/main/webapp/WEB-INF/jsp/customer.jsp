...
<%--<%@ taglib prefix="itheima" uri="http://qst.com/common/"%>--%>
<%
...
<head>
	...
	<!-- 引入css样式文件 -->
	<!-- Bootstrap Core CSS -->
	<link href="<%=basePath%>css2/bootstrap.min.css" rel="stylesheet" />
	<!-- MetisMenu CSS -->
	<link href="<%=basePath%>css2/metisMenu.min.css" rel="stylesheet" />
	<!-- DataTables CSS -->
	<link href="<%=basePath%>css2/dataTables.bootstrap.css" rel="stylesheet" />
	<!-- Custom CSS -->
	<link href="<%=basePath%>css2/sb-admin-2.css" rel="stylesheet" />
	<!-- Custom Fonts -->
	<link href="<%=basePath%>css2/font-awesome.min.css" rel="stylesheet" type="text/css" />
	<link href="<%=basePath%>css2/boot-crm.css" rel="stylesheet" type="text/css" />
	<style type="text/css">
		#myModalLabel {
		}
	</style>
...
<!-- 引入js文件 -->
<!-- jQuery -->
<script src="<%=basePath%>js2/jquery-1.11.3.min.js"></script>
<!-- Bootstrap Core JavaScript -->
<script src="<%=basePath%>js2/bootstrap.min.js"></script>
<!-- Metis Menu Plugin JavaScript -->
<script src="<%=basePath%>js2/metisMenu.min.js"></script>
<!-- DataTables JavaScript -->
<script src="<%=basePath%>js2/jquery.dataTables.min.js"></script>
<script src="<%=basePath%>js2/dataTables.bootstrap.min.js"></script>
<!-- Custom Theme JavaScript -->
<script src="<%=basePath%>js2/sb-admin-2.js"></script>
<!-- 编写js代码 -->
